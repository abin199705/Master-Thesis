# -*- coding: utf-8 -*-
"""
Created on Thu Jun  3 08:34:43 2021
...
np.save('./save/VGG_decoded_imgs_1_SSIM_MASK_out', decoded_imgs_1)
AE1_code = encoder.predict(x_train)
np.save('./save/VGG_AE1_code_SSIM_MASK_out', AE1_code)

encoder.save("./save/VGG_encoder_model_1_SSIM_MASK_out.h5")
autoencoder_1.save("./save/VGG_autoencoder_1_SSIM_MASK_out.h5")
