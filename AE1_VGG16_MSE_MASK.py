...
np.save('./save/VGG_decoded_imgs_1_MSE_MASK', decoded_imgs_1)
AE1_code = encoder.predict(x_train)
np.save('./save/VGG_AE1_code_MSE_MASK', AE1_code)

encoder.save("./save/VGG_encoder_model_1_MSE_MASK.h5")
autoencoder_1.save("./save/VGG_autoencoder_1_MSE_MASK.h5")
