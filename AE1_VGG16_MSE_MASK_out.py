# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 20:09:33 2021
...
np.save('./save/VGG_decoded_imgs_1_MSE_MASK_out', decoded_imgs_1)
AE1_code = encoder.predict(x_train)
np.save('./save/VGG_AE1_code_MSE_MASK_out', AE1_code)

encoder.save("./save/VGG_encoder_model_1_MSE_MASK_out.h5")
autoencoder_1.save("./save/VGG_autoencoder_1_MSE_MASK_out.h5")
...
plt.show()
plt.imshow(np.squeeze(x_train[1]/255), cmap=plt.cm.gray_r)
plt.show()
