# -*- coding: utf-8 -*-
"""
Created on Mon May 24 18:05:19 2021
...
# 將AE模型架構存成圖片檔
plot_model(autoencoder_1, to_file='./save/VGG_autoencoder_RGB.png', show_shapes=True)


autoencoder_1.fit(x_train, x_train, nb_epoch=10000, batch_size=128, shuffle=True)

decoded_imgs_1 = autoencoder_1.predict(x_train)
np.save('./save/VGG_decoded_imgs_1_RGB', decoded_imgs_1)
AE1_code = encoder.predict(x_train)
np.save('./save/VGG_AE1_code_RGB', AE1_code)

encoder.save("./save/VGG_encoder_model_1_RGB.h5")
autoencoder_1.save("./save/VGG_autoencoder_1_RGB.h5")
